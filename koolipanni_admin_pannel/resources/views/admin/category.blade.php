...
@section('content')
    ...
    padding-right: 8px;"></i>Category</h4>

                    @include('layouts.admin.partials.flash-message')

                    <div class="btn1">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add Category</button>
                            ...
                            <form action="{{ url('/store_category') }}" enctype="multipart/form-data" method="post" id="create_category">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label for="input-file-max-fs">bannerImage</label>
                                        <input autocomplete="off" type="file" class="form-control" placeholder="bannerimage" id="bannerimage" name="bannerimage"   />
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            @foreach($category as $get)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 100%;height: 100px;" src="{{url('storage/' . $get->category_image)}}" width="20" height="20" />
                                    </td>
                                    <td>
                                        <img style="width: 100%;height: 100px;" src="{{url('storage/' . $get->bannerimg)}}" width="20" height="20" />
                                    </td>
                                    <td style="padding: 10px;"> <button  data-toggle="modal" data-target="#editexampleModal"
                                                                         ...
                                                                         row-bannimg="{{url('storage/' . $get->bannerimg)}}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @if(!empty($get->bannerimg))
                            <img src="{{url('storage/' . $get->bannerimg)}}" id="editbannerimg" width="200" height="100" />
                            <input type="file" class="form-control"  id="editbannerimg" name="editbannerimg"   />
                        @endif
                    </div>
                    <div class="modal-footer">
                        <button  class="btn btn-primary2">Submit</button>
